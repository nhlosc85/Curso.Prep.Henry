...
function eliminarPropiedad(objeto, unaPropiedad) {
  ...
  // Devuelve el objeto
  // Tu código:  //porq no me deja *delete objeto.unaPropiedad;*  ???????
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
  // var usuario = {
  //    *clave* posts: *valor* array de objetos post [{
  //                          *clave* likes: *valor* numeroentero }]
 // var usuario = {
  //   posts: [{
  //     likes: 9
  //   }]
  // };
  var resu = 0;
  for(let z = 0; z < usuario["posts"].length; z++) {
    resu = resu + usuario.posts[z].likes;
  }
  return resu;
